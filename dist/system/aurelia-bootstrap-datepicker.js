...
System.register(['aurelia-framework', 'aurelia-binding', 'bootstrap-datepicker', 'es6-object-assign'], function (_export, _context) {
  ...
  var customElement, bindable, inject, TaskQueue, BindingEngine, _dec, _dec2, _dec3, _class, id, defaultOptions, AureliaBootstrapDatepicker;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('AureliaBootstrapDatepicker', AureliaBootstrapDatepicker = (_dec = customElement('bootstrap-datepicker'), _dec2 = inject(Element, BindingEngine, TaskQueue), _dec3 = bindable('value', 'dpOptions', 'placeholder'), _dec(_class = _dec2(_class = _dec3(_class = function () {
