...
export let AureliaBootstrapDatepicker = (_dec = customElement('bootstrap-datepicker'), _dec2 = inject(Element, BindingEngine, TaskQueue), _dec3 = bindable({ changeHandler: 'valueChanged' }), _dec(_class = _dec2(_class = (_class2 = class AureliaBootstrapDatepicker {
